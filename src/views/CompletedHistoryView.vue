...
const completedList = ref<WaitingCustomer[]>([])
...
<template>
  <div class="history-container">
    ...
    <!-- 이력 없음 -->
    <div v-else-if="completedList.length === 0" class="no-history">
    ...
    <div v-else class="history-list">
      <div v-for="customer in completedList" :key="customer.id" class="history-card">
        <!-- 순번 -->
